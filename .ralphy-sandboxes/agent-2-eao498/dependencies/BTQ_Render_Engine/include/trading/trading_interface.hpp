...
public:
  ...
  using ExecutionCallback =
      std::function<void(const OrderManager::OrderExecution &)>;
  using PositionUpdateCallback =
      std::function<void(const PositionManager::Position &)>;
  using RiskAlertCallback =
      std::function<void(const RiskAssessment::RiskAlert &)>;
  ...
  std::string place_limit_order(const std::string &symbol,
                                 ...
                                 double price);
  std::string place_stop_order(const std::string &symbol,
                               OrderManager::OrderSide side, double quantity,
                               double stop_price);
