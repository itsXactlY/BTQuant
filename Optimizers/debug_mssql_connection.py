...
def test_connection_strings():
    ...
    connection_strings = [
        ...
        "DRIVER={ODBC Driver 17 for SQL Server};SERVER=localhost;DATABASE=master;UID=SA;PWD=q?}33YIToo:H%xue$Kr*;TrustServerCertificate=yes",
        
        # Format 2: Different driver name
        "DRIVER={SQL Server};SERVER=localhost;DATABASE=master;UID=SA;PWD=q?}33YIToo:H%xue$Kr*;TrustServerCertificate=yes",
        
        # Format 3: Using instance name
        "DRIVER={ODBC Driver 17 for SQL Server};SERVER=localhost\\SQLEXPRESS;DATABASE=master;UID=SA;PWD=q?}33YIToo:H%xue$Kr*;TrustServerCertificate=yes",
        
        # Format 4: Using port
        "DRIVER={ODBC Driver 17 for SQL Server};SERVER=localhost,1433;DATABASE=master;UID=SA;PWD=q?}33YIToo:H%xue$Kr*;TrustServerCertificate=yes",
