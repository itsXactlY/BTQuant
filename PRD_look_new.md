...
- [ ] Add color coding: green for positive change, red for negative, intensity increases with larger changes in `dependencies/BTQ_Render_Engine/src/components/watchlist_panel.cpp` [Complexity: S]
- [ ] Implement click-to-switch: clicking any symbol in watchlist changes all panels to display that symbol in `dependencies/BTQ_Render_Engine/src/components/watchlist_panel.cpp` [Complexity: M]
