...
int main() {
    ...
    // Update data
    panel->updateHeatmapData();
    panel->updateLargeOrderMarkers();
    
    std::cout << "Data updated successfully" << std::endl;
    
    // Test rendering (without actual ImGui context)
    // Note: This would normally require a proper ImGui context
