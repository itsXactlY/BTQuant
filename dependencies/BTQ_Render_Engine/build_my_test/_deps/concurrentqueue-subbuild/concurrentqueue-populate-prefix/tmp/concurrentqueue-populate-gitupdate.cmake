...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/alca/projects/PubBTQuant/.ralphy-worktrees/agent-4-1769694658807-6pne7j/dependencies/BTQ_Render_Engine/build_my_test/_deps/concurrentqueue-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/alca/projects/PubBTQuant/.ralphy-worktrees/agent-4-1769694658807-6pne7j/dependencies/BTQ_Render_Engine/build_my_test/_deps/concurrentqueue-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
