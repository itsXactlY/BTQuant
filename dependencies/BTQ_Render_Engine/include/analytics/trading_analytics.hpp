...
class TradingAnalytics {
 public:
  ...
  std::vector<std::pair<std::chrono::system_clock::time_point, double>> get_drawdown_periods()
      const;
  ...
  std::vector<Trade> get_trades_in_period(std::chrono::system_clock::time_point start,
