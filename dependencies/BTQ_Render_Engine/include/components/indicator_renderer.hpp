...
class IndicatorRenderer {
 public:
  ...
  void render_indicators(const std::string& symbol, RenderEngine::TimeFrame timeframe,
 ...
 private:
  ...
  const std::vector<double>& calculate_sma(const std::string& symbol,
                                           RenderEngine::TimeFrame timeframe, int period);
  ...
  const std::vector<double>& calculate_macd(const std::string& symbol,
                                            RenderEngine::TimeFrame timeframe, int period1,
                                            int period2, int period3);
