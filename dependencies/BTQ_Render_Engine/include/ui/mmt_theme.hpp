...
constexpr ImU32 COLOR_TEXT_SECONDARY  = IM_COL32(0x9A, 0x9E, 0xA3, 0xFF);  // #9A9EA3 - Secondary text
constexpr ImU32 COLOR_TEXT_DISABLED   = IM_COL32(0x5A, 0x5E, 0x63, 0xFF);  // #5A5E63 - Disabled text

// Accent Colors
constexpr ImU32 COLOR_ACCENT_PRIMARY  = IM_COL32(0x4A, 0x90, 0xFF, 0xFF);  // #4A90FF - Primary accent (blue)
...
constexpr ImU32 COLOR_NEUTRAL_BG     = IM_COL32(0x2A, 0x2E, 0x33, 0xFF);  // #2A2E33 - Neutral background
...
inline void ApplyMMTStyle(ImGuiStyle* style = nullptr) {
    ...
    colors[ImGuiCol_Grab] = ImColor(COLOR_ACCENT_PRIMARY);
    colors[ImGuiCol_GrabHovered] = ImColor(COLOR_ACCENT_HOVER);
    colors[ImGuiCol_GrabActive] = ImColor(COLOR_ACCENT_ACTIVE);
