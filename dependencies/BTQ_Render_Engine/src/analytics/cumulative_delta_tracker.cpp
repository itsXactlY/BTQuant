...
CumulativeDeltaTracker::CumulativeDeltaTracker() : impl_(std::make_unique<Impl>()) {}
...
double CumulativeDeltaTracker::get_cumulative_delta() const { return impl_->cumulative_delta; }
...
bool CumulativeDeltaTracker::is_reset() const { return impl_->has_been_reset; }
...
std::optional<std::chrono::system_clock::time_point> CumulativeDeltaTracker::get_last_update_time()
    const {
