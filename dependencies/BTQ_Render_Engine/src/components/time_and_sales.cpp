...
#ifdef __linux__
void TimeAndSalesPanel::generateAndPlayTone(int frequency, int duration_ms,
...
std::vector<TimeAndSalesPanel::LogBucket> TimeAndSalesPanel::computeLogarithmicTradeSizeHistogram(
...
bool TimeAndSalesPanel::isTradeClustered(int index,
                                         const std::vector<RenderEngine::TradeData>& trades) const {
...
double TimeAndSalesPanel::calculateTradesPerMinute(
