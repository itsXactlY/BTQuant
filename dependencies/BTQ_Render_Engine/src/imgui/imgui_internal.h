...
enum ImGuiNavMoveFlags_ {
  ...
  ImGuiNavMoveFlags_ScrollToEdgeY = 1
                                    << 6,  // Force scrolling to min/max (used by Home/End) //
...
struct IMGUI_API ImGuiWindow {
  ...
  ImGuiWindowBgClickFlags BgClickFlags
      : 8;  // Configure behavior of click+dragging on window bg/void or over items. Default sets by
...
IMGUI_API void ImFontAtlasBuildNotifySetFont(ImFontAtlas* atlas, ImFont* old_font,
                                             ImFont* new_font);
