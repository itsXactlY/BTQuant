...
int main(int argc, char* argv[]) {
    ...
    fprintf(stderr, "║   Modern Vulkan | Real-time Data | Professional UI        ║\n");
    fprintf(stderr, "╚════════════════════════════════════════════════════════════╝\n\n");
    
    fprintf(stderr, "[Main] Initializing advanced Vulkan dashboard (1280x720)...\n");
    fprintf(stderr, "[Main] Features: MSAA, HDR, Compute Shaders, HotSpine Integration\n");
