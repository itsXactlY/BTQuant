 ...
 * with dynamic LOD, frustum culling, adaptive quality scaling, and GPU
 * optimization.
 */
...
private:
  ...
  void initialize_default_settings() {
    ...
    settings_.quality_levels[0] = {.geometry_detail = 1.0f,
    ...
    settings_.quality_levels[1] = {.geometry_detail = 0.7f,
    ...
    settings_.quality_levels[2] = {.geometry_detail = 0.4f,
    ...
    // Culled (not rendered)
    settings_.quality_levels[3] = {.geometry_detail = 0.0f,
...
private:
  ...
  void initialize_quality_presets() {
    ...
    quality_presets_["Ultra"] = {.render_scale = 1.5f,
                                 .msaa_samples = 8,
                                 .enable_bloom = true,
                                 .enable_ssao = true,
    ...
    // High quality preset
    quality_presets_["High"] = {.render_scale = 1.0f,
                                .msaa_samples = 4,
                                .enable_bloom = true,
                                .enable_ssao = true,
    ...
    quality_presets_["Medium"] = {.render_scale = 0.8f,
                                  .msaa_samples = 2,
                                  .enable_bloom = true,
                                  .enable_ssao = false,
                                  .enable_motion_blur = false,
    ...
    // Low quality preset
    quality_presets_["Low"] = {.render_scale = 0.6f,
                               .msaa_samples = 1,
                               .enable_bloom = false,
                               .enable_ssao = false,
                               .enable_motion_blur = false,
    ...
    // Performance preset
    quality_presets_["Performance"] = {.render_scale = 0.5f,
                                       .msaa_samples = 1,
                                       .enable_bloom = false,
                                       .enable_ssao = false,
                                       .enable_motion_blur = false,
...
public:
  ...
  void shutdown() { stop_monitoring_thread(); }
