...
SystemOptimizer::SystemOptimizer() : auto_optimization_enabled_(false), target_fps_(60.0) {
...
void SystemOptimizer::set_performance_target(double target_fps) { target_fps_ = target_fps; }

double SystemOptimizer::get_current_fps() const { return target_fps_; }
...
void SystemOptimizer::enable_auto_optimization(bool enable) { auto_optimization_enabled_ = enable; }

bool SystemOptimizer::is_auto_optimization_enabled() const { return auto_optimization_enabled_; }
