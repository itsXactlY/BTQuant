...
// Constructor
KeyboardShortcutsComponent::KeyboardShortcutsComponent(const glm::vec2& position, const glm::vec2& size)
...
void KeyboardShortcutsComponent::initialize_default_shortcuts() {
    ...
    shortcuts_["toggle_fullscreen"] = {"toggle_fullscreen", "Toggle Fullscreen Mode", "F11", [](){ /* callback */ }, true};
    shortcuts_["save_layout"] = {"save_layout", "Save Current Layout", "Ctrl+S", [](){ /* callback */ }, true};
    shortcuts_["load_layout"] = {"load_layout", "Load Layout", "Ctrl+L", [](){ /* callback */ }, true};
    shortcuts_["take_screenshot"] = {"take_screenshot", "Take Screenshot", "Ctrl+Shift+S", [](){ /* callback */ }, true};
    shortcuts_["open_settings"] = {"open_settings", "Open Settings Dialog", "Ctrl+,", [](){ /* callback */ }, true};
    shortcuts_["new_workspace"] = {"new_workspace", "Create New Workspace", "Ctrl+N", [](){ /* callback */ }, true};
    shortcuts_["close_tab"] = {"close_tab", "Close Current Tab", "Ctrl+W", [](){ /* callback */ }, true};
    shortcuts_["zoom_in"] = {"zoom_in", "Zoom In", "Ctrl++", [](){ /* callback */ }, true};
    shortcuts_["zoom_out"] = {"zoom_out", "Zoom Out", "Ctrl+-", [](){ /* callback */ }, true};
    shortcuts_["reset_zoom"] = {"reset_zoom", "Reset Zoom Level", "Ctrl+0", [](){ /* callback */ }, true};
    ...
    shortcuts_["duplicate"] = {"duplicate", "Duplicate Selection", "Ctrl+D", [](){ /* callback */ }, true};
    shortcuts_["search"] = {"search", "Open Search Dialog", "Ctrl+F", [](){ /* callback */ }, true};
    shortcuts_["find_next"] = {"find_next", "Find Next Occurrence", "F3", [](){ /* callback */ }, true};
    shortcuts_["find_prev"] = {"find_prev", "Find Previous Occurrence", "Shift+F3", [](){ /* callback */ }, true};
    shortcuts_["toggle_console"] = {"toggle_console", "Toggle Console Panel", "`", [](){ /* callback */ }, true};
    shortcuts_["toggle_watchlist"] = {"toggle_watchlist", "Toggle Watchlist Panel", "Ctrl+Shift+W", [](){ /* callback */ }, true};
    shortcuts_["toggle_orders"] = {"toggle_orders", "Toggle Orders Panel", "Ctrl+Shift+O", [](){ /* callback */ }, true};
    shortcuts_["toggle_positions"] = {"toggle_positions", "Toggle Positions Panel", "Ctrl+Shift+P", [](){ /* callback */ }, true};
    shortcuts_["quick_buy"] = {"quick_buy", "Quick Buy Order", "F9", [](){ /* callback */ }, true};
    shortcuts_["quick_sell"] = {"quick_sell", "Quick Sell Order", "F10", [](){ /* callback */ }, true};
    shortcuts_["cancel_all_orders"] = {"cancel_all_orders", "Cancel All Orders", "Ctrl+Shift+C", [](){ /* callback */ }, true};
}
...
bool KeyboardShortcutsComponent::handle_key_event(int keycode, bool pressed, uint32_t modifiers) {
    ...
    std::string key_name = "";
    switch (keycode) {
        case 32: key_name = "Space"; break;  // Space
        case 39: key_name = "'"; break;      // Apostrophe
        case 44: key_name = ","; break;      // Comma
        case 45: key_name = "-"; break;      // Minus
        case 46: key_name = "."; break;      // Period
        case 47: key_name = "/"; break;      // Slash
        case 48: key_name = "0"; break;
        case 49: key_name = "1"; break;
        case 50: key_name = "2"; break;
        case 51: key_name = "3"; break;
        case 52: key_name = "4"; break;
        case 53: key_name = "5"; break;
        case 54: key_name = "6"; break;
        case 55: key_name = "7"; break;
        case 56: key_name = "8"; break;
        case 57: key_name = "9"; break;
        case 59: key_name = ";"; break;      // Semicolon
        case 61: key_name = "="; break;      // Equal
        case 65: key_name = "A"; break;
        case 66: key_name = "B"; break;
        case 67: key_name = "C"; break;
        case 68: key_name = "D"; break;
        case 69: key_name = "E"; break;
        case 70: key_name = "F"; break;
        case 71: key_name = "G"; break;
        case 72: key_name = "H"; break;
        case 73: key_name = "I"; break;
        case 74: key_name = "J"; break;
        case 75: key_name = "K"; break;
        case 76: key_name = "L"; break;
        case 77: key_name = "M"; break;
        case 78: key_name = "N"; break;
        case 79: key_name = "O"; break;
        case 80: key_name = "P"; break;
        case 81: key_name = "Q"; break;
        case 82: key_name = "R"; break;
        case 83: key_name = "S"; break;
        case 84: key_name = "T"; break;
        case 85: key_name = "U"; break;
        case 86: key_name = "V"; break;
        case 87: key_name = "W"; break;
        case 88: key_name = "X"; break;
        case 89: key_name = "Y"; break;
        case 90: key_name = "Z"; break;
        case 91: key_name = "["; break;      // Left bracket
        case 92: key_name = "\\"; break;     // Backslash
        case 93: key_name = "]"; break;      // Right bracket
        case 96: key_name = "`"; break;      // Grave accent
        case 256: key_name = "Esc"; break;
        case 257: key_name = "Enter"; break;
        case 258: key_name = "Tab"; break;
        case 259: key_name = "Backspace"; break;
        case 260: key_name = "Insert"; break;
        case 261: key_name = "Del"; break;
        case 262: key_name = "Right"; break;
        case 263: key_name = "Left"; break;
        case 264: key_name = "Down"; break;
        case 265: key_name = "Up"; break;
        case 266: key_name = "Page Up"; break;
        case 267: key_name = "Page Down"; break;
        case 268: key_name = "Home"; break;
        case 269: key_name = "End"; break;
        case 280: key_name = "Caps Lock"; break;
        case 281: key_name = "Scroll Lock"; break;
        case 282: key_name = "Num Lock"; break;
        case 283: key_name = "Print Screen"; break;
        case 284: key_name = "Pause"; break;
        case 290: key_name = "F1"; break;
        case 291: key_name = "F2"; break;
        case 292: key_name = "F3"; break;
        case 293: key_name = "F4"; break;
        case 294: key_name = "F5"; break;
        case 295: key_name = "F6"; break;
        case 296: key_name = "F7"; break;
        case 297: key_name = "F8"; break;
        case 298: key_name = "F9"; break;
        case 299: key_name = "F10"; break;
        case 300: key_name = "F11"; break;
        case 301: key_name = "F12"; break;
        case 320: key_name = "KP 0"; break;  // Keypad 0
        case 321: key_name = "KP 1"; break;
        case 322: key_name = "KP 2"; break;
        case 323: key_name = "KP 3"; break;
        case 324: key_name = "KP 4"; break;
        case 325: key_name = "KP 5"; break;
        case 326: key_name = "KP 6"; break;
        case 327: key_name = "KP 7"; break;
        case 328: key_name = "KP 8"; break;
        case 329: key_name = "KP 9"; break;
        case 330: key_name = "KP ."; break;  // Keypad .
        case 331: key_name = "KP /"; break;  // Keypad /
        case 332: key_name = "KP *"; break;  // Keypad *
        case 333: key_name = "KP -"; break;  // Keypad -
        case 334: key_name = "KP +"; break;  // Keypad +
        case 335: key_name = "KP Enter"; break;
        case 336: key_name = "KP ="; break;  // Keypad =
...
void KeyboardShortcutsComponent::render_gui() {
    ...
    // Table of shortcuts
    if (ImGui::BeginTable("shortcuts_table", 4, ImGuiTableFlags_Borders | ImGuiTableFlags_ScrollY | ImGuiTableFlags_RowBg)) {
