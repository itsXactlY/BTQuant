...
void UnifiedThemeManager::apply_to_imgui() const {
    ...
    // Apply colors
    style.Colors[ImGuiCol_Text] = ImVec4(theme.colors.text_primary[0], 
                                         theme.colors.text_primary[1], 
                                         theme.colors.text_primary[2], 
                                         theme.colors.text_primary[3]);
    style.Colors[ImGuiCol_TextDisabled] = ImVec4(theme.colors.text_muted[0], 
                                                 theme.colors.text_muted[1], 
                                                 theme.colors.text_muted[2], 
                                                 theme.colors.text_muted[3]);
    style.Colors[ImGuiCol_WindowBg] = ImVec4(theme.colors.background_panel[0], 
                                             theme.colors.background_panel[1], 
                                             theme.colors.background_panel[2], 
                                             theme.colors.background_panel[3]);
    style.Colors[ImGuiCol_ChildBg] = ImVec4(theme.colors.background_secondary[0], 
                                            theme.colors.background_secondary[1], 
                                            theme.colors.background_secondary[2], 
                                            theme.colors.background_secondary[3]);
    style.Colors[ImGuiCol_PopupBg] = ImVec4(theme.colors.background_primary[0], 
                                            theme.colors.background_primary[1], 
                                            theme.colors.background_primary[2], 
                                            theme.colors.background_primary[3]);
    style.Colors[ImGuiCol_Border] = ImVec4(theme.colors.border_color[0], 
                                           theme.colors.border_color[1], 
                                           theme.colors.border_color[2], 
                                           theme.colors.border_color[3]);
    style.Colors[ImGuiCol_FrameBg] = ImVec4(theme.colors.background_secondary[0], 
                                            theme.colors.background_secondary[1], 
                                            theme.colors.background_secondary[2], 
                                            theme.colors.background_secondary[3] * 0.7f);
    style.Colors[ImGuiCol_TitleBg] = ImVec4(theme.colors.background_primary[0], 
                                            theme.colors.background_primary[1], 
                                            theme.colors.background_primary[2], 
                                            theme.colors.background_primary[3]);
    style.Colors[ImGuiCol_TitleBgActive] = ImVec4(theme.colors.accent_primary[0], 
                                                  theme.colors.accent_primary[1], 
                                                  theme.colors.accent_primary[2], 
                                                  theme.colors.accent_primary[3]);
    style.Colors[ImGuiCol_MenuBarBg] = ImVec4(theme.colors.background_secondary[0], 
                                              theme.colors.background_secondary[1], 
                                              theme.colors.background_secondary[2], 
                                              theme.colors.background_secondary[3]);
    style.Colors[ImGuiCol_ScrollbarBg] = ImVec4(theme.colors.background_secondary[0], 
                                                theme.colors.background_secondary[1], 
                                                theme.colors.background_secondary[2], 
                                                theme.colors.background_secondary[3] * 0.2f);
    style.Colors[ImGuiCol_ScrollbarGrab] = ImVec4(theme.colors.accent_primary[0], 
                                                  theme.colors.accent_primary[1], 
                                                  theme.colors.accent_primary[2], 
                                                  theme.colors.accent_primary[3] * 0.6f);
    style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(theme.colors.accent_primary[0], 
                                                         theme.colors.accent_primary[1], 
                                                         theme.colors.accent_primary[2], 
                                                         theme.colors.accent_primary[3] * 0.8f);
    style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(theme.colors.accent_primary[0], 
                                                        theme.colors.accent_primary[1], 
                                                        theme.colors.accent_primary[2], 
                                                        theme.colors.accent_primary[3]);
    style.Colors[ImGuiCol_CheckMark] = ImVec4(theme.colors.accent_primary[0], 
                                              theme.colors.accent_primary[1], 
                                              theme.colors.accent_primary[2], 
                                              theme.colors.accent_primary[3]);
    style.Colors[ImGuiCol_SliderGrab] = ImVec4(theme.colors.accent_primary[0], 
                                               theme.colors.accent_primary[1], 
                                               theme.colors.accent_primary[2], 
                                               theme.colors.accent_primary[3]);
    style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(theme.colors.accent_secondary[0], 
                                                     theme.colors.accent_secondary[1], 
                                                     theme.colors.accent_secondary[2], 
                                                     theme.colors.accent_secondary[3]);
    style.Colors[ImGuiCol_Button] = ImVec4(theme.colors.accent_primary[0], 
                                           theme.colors.accent_primary[1], 
                                           theme.colors.accent_primary[2], 
                                           theme.colors.accent_primary[3] * 0.4f);
    style.Colors[ImGuiCol_ButtonHovered] = ImVec4(theme.colors.accent_primary[0], 
                                                  theme.colors.accent_primary[1], 
                                                  theme.colors.accent_primary[2], 
                                                  theme.colors.accent_primary[3] * 0.6f);
    style.Colors[ImGuiCol_ButtonActive] = ImVec4(theme.colors.accent_primary[0], 
                                                 theme.colors.accent_primary[1], 
                                                 theme.colors.accent_primary[2], 
                                                 theme.colors.accent_primary[3] * 0.8f);
    style.Colors[ImGuiCol_Header] = ImVec4(theme.colors.accent_primary[0], 
                                           theme.colors.accent_primary[1], 
                                           theme.colors.accent_primary[2], 
                                           theme.colors.accent_primary[3] * 0.4f);
    style.Colors[ImGuiCol_HeaderHovered] = ImVec4(theme.colors.accent_primary[0], 
                                                  theme.colors.accent_primary[1], 
                                                  theme.colors.accent_primary[2], 
                                                  theme.colors.accent_primary[3] * 0.6f);
    style.Colors[ImGuiCol_HeaderActive] = ImVec4(theme.colors.accent_primary[0], 
                                                 theme.colors.accent_primary[1], 
                                                 theme.colors.accent_primary[2], 
                                                 theme.colors.accent_primary[3] * 0.8f);
    style.Colors[ImGuiCol_Separator] = ImVec4(theme.colors.border_color[0], 
                                              theme.colors.border_color[1], 
                                              theme.colors.border_color[2], 
                                              theme.colors.border_color[3]);
    style.Colors[ImGuiCol_SeparatorHovered] = ImVec4(theme.colors.accent_primary[0], 
                                                     theme.colors.accent_primary[1], 
                                                     theme.colors.accent_primary[2], 
                                                     theme.colors.accent_primary[3]);
    style.Colors[ImGuiCol_SeparatorActive] = ImVec4(theme.colors.accent_primary[0], 
                                                    theme.colors.accent_primary[1], 
                                                    theme.colors.accent_primary[2], 
                                                    theme.colors.accent_primary[3]);
    style.Colors[ImGuiCol_ResizeGrip] = ImVec4(theme.colors.accent_primary[0], 
                                               theme.colors.accent_primary[1], 
                                               theme.colors.accent_primary[2], 
                                               theme.colors.accent_primary[3] * 0.4f);
    style.Colors[ImGuiCol_ResizeGripHovered] = ImVec4(theme.colors.accent_primary[0], 
                                                      theme.colors.accent_primary[1], 
                                                      theme.colors.accent_primary[2], 
                                                      theme.colors.accent_primary[3] * 0.6f);
    style.Colors[ImGuiCol_ResizeGripActive] = ImVec4(theme.colors.accent_primary[0], 
                                                     theme.colors.accent_primary[1], 
                                                     theme.colors.accent_primary[2], 
                                                     theme.colors.accent_primary[3] * 0.8f);
    style.Colors[ImGuiCol_Tab] = ImVec4(theme.colors.background_secondary[0], 
                                        theme.colors.background_secondary[1], 
                                        theme.colors.background_secondary[2], 
                                        theme.colors.background_secondary[3] * 0.8f);
    style.Colors[ImGuiCol_TabHovered] = ImVec4(theme.colors.accent_primary[0], 
                                               theme.colors.accent_primary[1], 
                                               theme.colors.accent_primary[2], 
                                               theme.colors.accent_primary[3] * 0.6f);
    style.Colors[ImGuiCol_TabActive] = ImVec4(theme.colors.background_panel[0], 
                                              theme.colors.background_panel[1], 
                                              theme.colors.background_panel[2], 
                                              theme.colors.background_panel[3]);
    style.Colors[ImGuiCol_PlotLines] = ImVec4(theme.colors.accent_primary[0], 
                                              theme.colors.accent_primary[1], 
                                              theme.colors.accent_primary[2], 
                                              theme.colors.accent_primary[3]);
    style.Colors[ImGuiCol_PlotHistogram] = ImVec4(theme.colors.accent_secondary[0], 
                                                  theme.colors.accent_secondary[1], 
                                                  theme.colors.accent_secondary[2], 
                                                  theme.colors.accent_secondary[3]);
    style.Colors[ImGuiCol_TextSelectedBg] = ImVec4(theme.colors.accent_primary[0], 
                                                   theme.colors.accent_primary[1], 
                                                   theme.colors.accent_primary[2], 
                                                   theme.colors.accent_primary[3] * 0.3f);
    ...
    style.Colors[ImGuiCol_DockingPreview] = ImVec4(theme.shadow_normal.color[0],
                                                   theme.shadow_normal.color[1],
                                                   theme.shadow_normal.color[2],
                                                   theme.shadow_normal.color[3]);
    #endif
}
...
void UnifiedThemeManager::get_color(const std::string& color_name, float* rgba) const {
    ...
    if (it == themes_.end()) {
        ...
        rgba[0] = 0.5f; rgba[1] = 0.5f; rgba[2] = 0.5f; rgba[3] = 1.0f;
        return;
    }
...
bool UnifiedThemeManager::save_theme(const std::string& theme_name, const std::string& file_path) const {
    auto it = themes_.find(theme_name);
    if (it == themes_.end()) {
        return false;
    }
...
void UnifiedThemeManager::create_preview(const std::string& theme_name, const std::string& output_path) const {
...
std::vector<std::string> UnifiedThemeManager::get_themes_by_category(const std::string& category) const {
    std::vector<std::string> theme_names;
    for (const auto& pair : themes_) {
...
bool UnifiedThemeManager::save_theme_to_file(const ThemeDefinition& theme, const std::string& file_path) const {
    nlohmann::json j;
    ...
    colors["background_primary"] = nlohmann::json::array({theme.colors.background_primary[0],
                                                          theme.colors.background_primary[1],
                                                          theme.colors.background_primary[2],
                                                          theme.colors.background_primary[3]});
    colors["background_secondary"] = nlohmann::json::array({theme.colors.background_secondary[0],
                                                            theme.colors.background_secondary[1],
                                                            theme.colors.background_secondary[2],
                                                            theme.colors.background_secondary[3]});
    colors["background_panel"] = nlohmann::json::array({theme.colors.background_panel[0],
                                                        theme.colors.background_panel[1],
                                                        theme.colors.background_panel[2],
                                                        theme.colors.background_panel[3]});
    colors["text_primary"] = nlohmann::json::array({theme.colors.text_primary[0],
                                                    theme.colors.text_primary[1],
                                                    theme.colors.text_primary[2],
                                                    theme.colors.text_primary[3]});
    colors["text_secondary"] = nlohmann::json::array({theme.colors.text_secondary[0],
                                                      theme.colors.text_secondary[1],
                                                      theme.colors.text_secondary[2],
                                                      theme.colors.text_secondary[3]});
    colors["text_muted"] = nlohmann::json::array({theme.colors.text_muted[0],
                                                  theme.colors.text_muted[1],
                                                  theme.colors.text_muted[2],
                                                  theme.colors.text_muted[3]});
    colors["price_up"] = nlohmann::json::array({theme.colors.price_up[0],
                                               theme.colors.price_up[1],
                                               theme.colors.price_up[2],
                                               theme.colors.price_up[3]});
    colors["price_down"] = nlohmann::json::array({theme.colors.price_down[0],
                                                 theme.colors.price_down[1],
                                                 theme.colors.price_down[2],
                                                 theme.colors.price_down[3]});
    colors["price_neutral"] = nlohmann::json::array({theme.colors.price_neutral[0],
                                                     theme.colors.price_neutral[1],
                                                     theme.colors.price_neutral[2],
                                                     theme.colors.price_neutral[3]});
    colors["accent_primary"] = nlohmann::json::array({theme.colors.accent_primary[0],
                                                     theme.colors.accent_primary[1],
                                                     theme.colors.accent_primary[2],
                                                     theme.colors.accent_primary[3]});
    colors["accent_secondary"] = nlohmann::json::array({theme.colors.accent_secondary[0],
                                                       theme.colors.accent_secondary[1],
                                                       theme.colors.accent_secondary[2],
                                                       theme.colors.accent_secondary[3]});
    colors["border_color"] = nlohmann::json::array({theme.colors.border_color[0],
                                                    theme.colors.border_color[1],
                                                    theme.colors.border_color[2],
                                                    theme.colors.border_color[3]});
    colors["status_connected"] = nlohmann::json::array({theme.colors.status_connected[0],
                                                        theme.colors.status_connected[1],
                                                        theme.colors.status_connected[2],
                                                        theme.colors.status_connected[3]});
    colors["status_disconnected"] = nlohmann::json::array({theme.colors.status_disconnected[0],
                                                           theme.colors.status_disconnected[1],
                                                           theme.colors.status_disconnected[2],
                                                           theme.colors.status_disconnected[3]});
    colors["status_warning"] = nlohmann::json::array({theme.colors.status_warning[0],
                                                      theme.colors.status_warning[1],
                                                      theme.colors.status_warning[2],
                                                      theme.colors.status_warning[3]});
    j["colors"] = colors;
