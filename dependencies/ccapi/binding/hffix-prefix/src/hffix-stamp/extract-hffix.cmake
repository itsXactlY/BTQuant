...
#
get_filename_component(filename "/home/alca/projects/PubBTQuant/dependencies/ccapi/binding/hffix-prefix/src/v1.4.1.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/alca/projects/PubBTQuant/dependencies/ccapi/binding/hffix" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-hffix${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-hffix${i}")
