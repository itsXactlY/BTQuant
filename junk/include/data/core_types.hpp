...
struct SymbolInfo {
  ...
  SymbolInfo() 
    : id(0), symbol_id(0), min_notional(0.0), min_qty(0.0), max_qty(0.0),
      step_size(0.0), tick_size(0.0), status("active") {}

  SymbolInfo(uint32_t i, uint32_t sid, const std::string& ex, 
             const std::string& sym, const std::string& k)
    : id(i), symbol_id(sid), exchange(ex), symbol(sym), key(k),
      min_notional(0.0), min_qty(0.0), max_qty(0.0), step_size(0.0), 
      tick_size(0.0), status("active") {}
};

// ============================================================================
// 4. OrderBook Snapshot (Standard Layout POD for ring buffer)
// ============================================================================
...
// ============================================================================
// 5. HotSpine Shared Memory Types (Lock-Free Architecture)
// ============================================================================
