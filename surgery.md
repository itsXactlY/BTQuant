...
- [ ] **1.1: Delete the UI Hydras (Legacy Dashboards & Layouts)**
...
- [ ] **1.2: Delete the Data Hydras (Exchange Connections in the Renderer)**
...
- [ ] **1.3: Delete the Optimization Hydra**
...
- [ ] **1.4: Delete the Old Renderer Monolith**
...
- [ ] **1.5: Eradicate All Test Files from the Build Tree**
...
- [ ] **2.1: Rewire `src/main_trading_terminal.cpp`**
...
- [ ] **3.1: Define Atomic Storage (`include/market_data_processor.hpp`)**
    - **Add Struct:**
      ```cpp
...
- [ ] **3.2: Implement High-Frequency Poller (`src/data/market_data_processor.cpp`)**
...
- [ ] **4.1: Watchlist Lobotomy (`include/components/watchlist_panel.hpp` & `src/components/watchlist_panel.cpp`)**
...
- [ ] **4.2: Orderbook Lock-Free Read (`src/components/orderbook_panel.cpp`)**
