...
// Include the standalone indicator alerts
#include "standalone_indicator_alerts.hpp"

int main() {
    std::cout << "Testing Standalone Indicator Alerts System..." << std::endl;

    btq::IndicatorAlerts alerts;

    // Enable logging
    alerts.enableLogging(true);
    alerts.setLogFilePath("standalone_indicator_alerts_test.log");
    ...
    std::cout << "\nStandalone Indicator Alerts test completed!" << std::endl;
    std::cout << "Check standalone_indicator_alerts_test.log for logged alerts." << std::endl;
