...
enum class ImbalanceDirection { LONG, SHORT, NEUTRAL };
...
public:
  ...
  // Configuration
  void set_depth_ratio_threshold(double ratio) {
    depth_ratio_threshold_ = ratio;
  }
...
private:
  ...
  double calculate_orderbook_depth(const OrderbookData &ob,
