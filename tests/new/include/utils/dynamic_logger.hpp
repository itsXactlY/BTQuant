...
private:
    ...
    void write_message(LogLevel level, 
                       const std::string& component,
                       const std::string& message,
                       const std::string& file,
                       int line,
...
class LogStream {
public:
    LogStream(DynamicLogger& logger, LogLevel level, 
              const std::string& component,
...
#define BTQ_LOG_DEBUG(component, message) \
    LogStream(DynamicLogger::instance(), LogLevel::DEBUG, component, \
              __FILE__, __LINE__, __FUNCTION__).stream()

#define BTQ_LOG_INFO(component, message) \
    LogStream(DynamicLogger::instance(), LogLevel::INFO, component, \
              __FILE__, __LINE__, __FUNCTION__).stream()

#define BTQ_LOG_WARNING(component, message) \
    LogStream(DynamicLogger::instance(), LogLevel::WARNING, component, \
              __FILE__, __LINE__, __FUNCTION__).stream()

#define BTQ_LOG_ERROR(component, message) \
    LogStream(DynamicLogger::instance(), LogLevel::ERROR, component, \
              __FILE__, __LINE__, __FUNCTION__).stream()
...
#define BTQ_LOG(component, level, message) \
    DynamicLogger::instance().log(level, component, message, __FILE__, __LINE__, __FUNCTION__)
