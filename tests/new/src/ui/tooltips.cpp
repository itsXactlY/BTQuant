...
void TooltipManager::initialize_default_tooltips() {
    ...
    register_tooltip("chart_autofollow_toggle", "Automatically follow the latest data as it arrives");
    register_tooltip("chart_show_liquidity_bars", "Toggle visibility of liquidity bars showing bid/ask volumes");
    register_tooltip("chart_liquidity_bar_width", "Adjust the width of liquidity bars in pixels");
    register_tooltip("chart_liquidity_opacity", "Adjust the transparency of liquidity bars");
    ...
    register_tooltip("enable_macd", "Enable Moving Average Convergence Divergence indicator");
    register_tooltip("enable_stochastic", "Enable Stochastic oscillator for momentum analysis");
    register_tooltip("enable_atr", "Enable Average True Range volatility indicator");
