...
bool ConsoleLogSink::is_enabled(LogLevel) const {
  return true; // Always enabled for console
}

// File log sink implementation
FileLogSink::FileLogSink(const std::string &path) : path_(path) { open(path); }
...
bool FileLogSink::is_enabled(LogLevel) const { return file_ != nullptr; }
...
bool DynamicLogger::initialize(const std::string &) {
...
bool DynamicLogger::is_enabled(LogLevel level,
...
void DynamicLogger::log(LogLevel level, const std::string &component,
...
void DynamicLogger::debug(const std::string &component,
                          const std::string &message, const std::string &file,
                          int line, const std::string &function) {
  log(LogLevel::DEBUG, component, message, file, line, function);
}

void DynamicLogger::info(const std::string &component,
                         const std::string &message, const std::string &file,
                         int line, const std::string &function) {
  log(LogLevel::INFO, component, message, file, line, function);
}

void DynamicLogger::warning(const std::string &component,
                            const std::string &message, const std::string &file,
                            int line, const std::string &function) {
  log(LogLevel::WARNING, component, message, file, line, function);
}

void DynamicLogger::error(const std::string &component,
                          const std::string &message, const std::string &file,
                          int line, const std::string &function) {
  log(LogLevel::ERROR, component, message, file, line, function);
}

void DynamicLogger::critical(const std::string &component,
...
void DynamicLogger::write_message(LogLevel level, const std::string &component,
                                  const std::string &message,
                                  const std::string &file, int line,
                                  const std::string &function) {
  LogMessage msg;
...
DynamicLogger::~DynamicLogger() { shutdown(); }
