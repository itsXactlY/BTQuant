...
// Simplified version of the structures we need for testing
namespace BTQuant {
...
// Simplified version of the indicator alerts system
...
int main() {
    ...
    alerts.setLogFilePath("simple_indicator_test.log");
    ...
    // Simulate price crossing SMA from below (bullish)
    ...
    // Simulate price crossing SMA from above (bearish)
    ...
    // Simulate Bollinger Band touch upper
    ...
    // Simulate Bollinger Band touch lower
    ...
    std::cout << "Check simple_indicator_test.log for logged alerts." << std::endl;
